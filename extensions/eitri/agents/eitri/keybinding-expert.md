...
### Key Helper (from the Pi TUI package named in the fetched docs)
- `Key.ctrl("x")` → `"ctrl+x"`
...
```bash
firecrawl scrape https://raw.githubusercontent.com/earendil-works/pi/main/packages/coding-agent/docs/keybindings.md -f markdown -o ${TMPDIR:-/tmp}/pi-keybindings-docs.md || curl -sL https://raw.githubusercontent.com/earendil-works/pi/main/packages/coding-agent/docs/keybindings.md -o ${TMPDIR:-/tmp}/pi-keybindings-docs.md
```
