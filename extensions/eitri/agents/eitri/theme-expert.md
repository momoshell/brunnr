...
```bash
firecrawl scrape https://raw.githubusercontent.com/earendil-works/pi/main/packages/coding-agent/docs/themes.md -f markdown -o ${TMPDIR:-/tmp}/pi-theme-docs.md || curl -sL https://raw.githubusercontent.com/earendil-works/pi/main/packages/coding-agent/docs/themes.md -o ${TMPDIR:-/tmp}/pi-theme-docs.md
```
